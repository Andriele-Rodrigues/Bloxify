...
object LevelGenerator {
    ...
    fun generateLevel(levelNumber: Int, screenWidth: Float, screenHeight: Float): Level {
        val rows = 5       // 5 Linhas de tijolos
        val columns = 8    // 8 Colunas de tijolos
        ...
        val brickHeight = 50f // Altura fixa de cada tijolo
